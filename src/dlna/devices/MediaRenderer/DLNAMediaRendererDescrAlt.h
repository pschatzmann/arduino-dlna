...
class DLNAMediaRendererTransportDescrAlt : public DLNADescr {
 public:
 ...
 */
class DLNAMediaRendererControlDescrAlt : public DLNADescr {
 public:
  size_t printDescr(Print& out) override {
    using tiny_dlna::XMLPrinter;
    XMLPrinter xml(out);
 ...
 */
class DLNAMediaRendererConnectionMgrDescrAlt : public DLNADescr {
 public:
  size_t printDescr(Print& out) override {
    using tiny_dlna::XMLPrinter;
    XMLPrinter xml(out);
